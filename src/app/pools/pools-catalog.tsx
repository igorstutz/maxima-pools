...
/* ------------------------------------------------------------------ */
/*  Catalog (client) — receives the pool list from the server page     */
/* ------------------------------------------------------------------ */

export function PoolsCatalog({ pools }: { pools: Pool[] }) {
  ...
  }, [pools, typeFilter, shapeFilter, sizeCategoryFilter, sizeFilter, widthFilter, nameSearch]);
